...
import static org.bluo.common.redis.util.RedisConstance.CACHE_LOCK_KEY;
import static org.bluo.common.redis.util.RedisConstance.CACHE_NULL_TTL;
...
public class RedisCache {
    ...
    private static final ExecutorService CACHE_REBUILD_EXECUTOR = new ThreadPoolExecutor(5, 10, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>());
     ...
     * @return 缓存对象
     */
    public <R, ID> R getWithMutex(String keyPrefix, ID id, Class<R> type, Function<ID, R> dbFallback, Long time, TimeUnit unit) {
        String key = keyPrefix + id;
        // 1.从redis查询缓存
